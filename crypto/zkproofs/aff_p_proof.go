...
func (proof * AffPProof) Nil() bool {
	...
	if proof.A == nil || proof.Bx == nil || proof.By  == nil ||
	    ...
	    proof.W == nil || proof.Wx == nil || proof.Wy == nil {
        return true
	}
	return false
}

func (proof *AffPProof) Bytes() [AffPProofParts][]byte {
	return [...][]byte{
    		proof.A.Bytes(),
    		proof.Bx.Bytes(),
    		proof.By.Bytes(),
...
func AffPProofFromBytes(bzs [][]byte) (*AffPProof, error) {
